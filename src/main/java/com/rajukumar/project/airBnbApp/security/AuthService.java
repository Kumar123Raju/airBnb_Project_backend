...
public class AuthService {
    ...
    public String refreshToken(String refereshToken){
        Long id=jwtService.getUserIdFromToken(refereshToken);
        User user=userRepository.findById(id).orElseThrow(()->new ResourceNotFoundException("Usr not found with id: "+id));
