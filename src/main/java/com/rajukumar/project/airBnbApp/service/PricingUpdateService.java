...
import com.rajukumar.project.airBnbApp.entity.HotelMinPrice;
...
public class PricingUpdateService {
    ...
    //Scheduler to update the invetnoyr and hotelmin price table every hour
    ...
    public void updatePrices(){
        ...
        log.info("Job Started to update the job");
    ...
    private void updateHotelMinPrice(Hotel hotel, List<Inventory> inventoryList, LocalDate startDate, LocalDate endDate) {
        //calculate minimum price per day for the hotel
...
//        prepare hotelprice entitites in bulk
