...
//
    ...
    public List<InventoryDto> getAllInventoryByRoom(Long roomId) {
        ...
        if(!user.equals(room.getHotel().getOwner())){
            throw new AccessDeniedException("You are not the owner of roomId with hotelid: "+roomId);
        }
    ...
    public void updateInventory(Long roomId, UpdateInventoryRequestDto updateInventoryRequestDto) {
        ...
        inventoryRepository.getInventoryAndLockBeforUpdate(roomId,updateInventoryRequestDto.getStartDate(),updateInventoryRequestDto.getEndDate());
